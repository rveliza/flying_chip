    ...
    for origin, option in destination.items():
        for destination, hours in option:
            ...
            try:
                ...
                flight_info = (time_now, origin, destination, deep_link, price, nightsInDest)
...
# link, destCityName, price, nights

cur.executemany("""
INSERT INTO cheapest_flights (time_now, cityCodeFrom, cityCodeTo, deep_link, price, nightsInDest) VALUES
            (?,?,?,?,?,?)""", data)
